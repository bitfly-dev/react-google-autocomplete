  ...
  _createClass(ReactGoogleAutocomplete, [{
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          rest = _objectWithoutProperties(_props3, ['onPlaceSelected', 'types', 'componentRestrictions', 'bounds', 'address', 'geoLocation', 'components', 'placeId']);

      return _react2.default.createElement(_reactBootstrap.FormControl, _extends({}, address.input, {
        ref: 'input'
...
ReactGoogleAutocomplete.propTypes = {
  ...
  address: _propTypes2.default.object.isRequired,
  geoLocation: _propTypes2.default.object,
  components: _propTypes2.default.array,
  placeId: _propTypes2.default.string
};
